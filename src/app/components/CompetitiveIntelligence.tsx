...
export default function CompetitiveIntelligence({
  ...
  const [platformData] = useState<PlatformComparison[]>([]);
  const [loading, setLoading] = useState(true);
  const [selectedView, setSelectedView] = useState<
    "overview" | "benchmarks" | "platforms"
  >("overview");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-white/60 backdrop-blur-sm border-white/20">
          <CardContent className="p-4">
            ...
            <div className="text-xs text-gray-600">
              of {competitors.length} tracked brands
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white/60 backdrop-blur-sm border-white/20">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">
              {yourBrand?.growth_rate.toFixed(1)}%
            </div>
        ...
        <Card className="bg-white/60 backdrop-blur-sm border-white/20">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">
              {yourBrand?.platform_coverage}/25
            </div>
      ...
      <Tabs
        value={selectedView}
        onValueChange={(value: string) => setSelectedView(value as "overview" | "benchmarks" | "platforms")}
        className="space-y-6"
      >
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        <span className="text-blue-600 font-medium">
                          You: {platform.yourBrand}
                        </span>
                        <span className="text-red-600">
                          Top: {platform.topCompetitor}
                        </span>
                        <span className="text-gray-600">
                          Leader: {platform.marketLeader}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-medium text-blue-600 w-16">
                          You
                        </span>
                      ...
                      {/* Top Competitor Bar */}
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-medium text-red-600 w-16">
                          Top
                        </span>
                        <div className="flex-1 bg-gray-200 rounded-full h-2">
                          <div
